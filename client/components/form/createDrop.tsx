...
const CreateDrop: FC<{ isOpen: boolean, setIsOpen: Dispatch<SetStateAction<boolean>> }> = ({ isOpen, setIsOpen }) => {
    ...
    const handleLink = async () => {
        console.log(name, description, dropTags)

        if (name && description && dropTags) {
            const res = await axios.post(`/api/drop/`, {
